...
server '57.128.196.156', port: 22, roles: %w(web app db), primary: true

set :application,             "nanoblog"
...
set :scm,                     :git
set :user,                    'nanoblog'
set :ssh_options,             { forward_agent: true, user: fetch(:user), keys: %w(~/.ssh/nanoblog_rsa) }
